...
$query = "SELECT * FROM packages WHERE category = 'Event'";
...
<head>
    ...
    <link rel="stylesheet" href="style\cust-event-other.css?v=<?php echo time(); ?>">
...
<body>
    <div class="container">
        <div class="main">
            ...
            <h2 id="topic1" style="text-align: center; margin: 35px;">Event Photoshoot</h2>
                ...
                <?php foreach ($packages as $package) { ?>
                    <div class="kotak">
                        ...
                        <div class="content">
                            ...
                            <ul>
                                <li style="font-weight: bolder;"><?php echo 'RM' . $package['package_price']; ?></li>
                                <?php
                                for ($i = 1; $i <= 6; $i++) {
